...
export const spritesvg = () => gulp.src(paths.svg.src)
	.pipe(svgmin({
		js2svg: {
			pretty: true
		}
...
export const prod = gulp.series(cleanFiles, serverConfig, views, styles, scripts, images, webpimages, spritesvg, fonts, favs);
